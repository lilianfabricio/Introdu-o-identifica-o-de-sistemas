%dados = readmatrix("Schroeder80mV.csv");
dados = load('SNLS80mV.mat');
entrada = dados(1,:);
saida = dados(2,:);

%entrada = V1(10585:10585+1023);  % select the Schroeder section of the experiment
%saida = V2(10585:10585+1023);
